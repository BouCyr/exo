# Multiplication Game (Exo)

A simple, mobile-first multiplication game for children with a neon aesthetic.
...
- **Customizable**: Change limits and frequencies in `config.json` to adjust difficulty.
